    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            ...
            <form method="POST" action="{{ route('account.login.post') }}" class="space-y-5">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1.5">Email or Mobile Number</label>
                    <input type="text" name="identifier" value="{{ old('identifier') }}" required autofocus
                           placeholder="Email or 03XX-XXXXXXX"
                           class="w-full px-4 py-2.5 border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent
                                  {{ $errors->has('identifier') ? 'border-red-400 bg-red-50' : 'border-gray-300 bg-gray-50' }}">
