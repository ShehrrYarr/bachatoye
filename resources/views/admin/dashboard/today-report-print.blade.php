...
<head>
    ...
    <title>Today's Report — {{ $todayReport['date'] }}</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .total-row .label { display: flex; align-items: center; gap-6px; }
...
<body>
    ...
    <div class="print-bar">
        <div style="display:flex;align-items:center;gap:12px;">
            ...
            <span>Today's Report — {{ $todayReport['date'] }}</span>
        </div>
    ...
    <div class="section pos">
        <div class="section-header">
            <span class="section-title">&#128179; POS Sales</span>
    ...
    <div class="section expense">
        <div class="section-header">
            ...
            <span class="section-total">Rs. {{ number_format($todayReport['expenses']) }}</span>
        </div>
    </div>
    ...
    <div class="section expense">
        <div class="section-header">
            <span class="section-title">&#129309; Vendor Payments (Out)</span>
            <span class="section-total">– Rs. {{ number_format($todayReport['vendor_pay_total']) }}</span>
        </div>
        <div class="breakdown">
            @if($todayReport['vendor_pay_cash'] > 0)
            <span><span class="dot dot-green"></span>Cash: Rs. {{ number_format($todayReport['vendor_pay_cash']) }}</span>
            @endif
            @if($todayReport['vendor_pay_bank'] > 0)
            <span><span class="dot dot-blue"></span>Bank: Rs. {{ number_format($todayReport['vendor_pay_bank']) }}</span>
            @endif
        </div>
    </div>
    @endif
    ...
    <div class="footer">
        <span>{{ $todayReport['store_name'] }}</span>
